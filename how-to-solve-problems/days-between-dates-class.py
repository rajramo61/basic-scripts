...
def isDate1GreaterThanDate2(year1, month1, day1, year2, month2, day2):
    if year1 > year2:
        return False
    if year1 == year2:
        if month1 > month2:
...
def daysBetweenDates(year1, month1, day1, year2, month2, day2):
    ...
    assert isDate1GreaterThanDate2(year1, month1, day1, year2, month2, day2), 'date2 should be greater than date1'
